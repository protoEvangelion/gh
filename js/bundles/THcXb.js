var pageComponent =
webpackJsonppageComponent([3,11,12],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
var _ElectricCodeTabs = __webpack_require__(25);
...
var _SocialButtons = __webpack_require__(22);
...
function $logo(opt_data, opt_ignored, opt_ijData) {
  ie_open('div', null, null,
    ...
    ie_open('a', null, null,
        ...
        'href', '/');
      ie_void('span', null, null,
          'class', 'topbar-logo-icon icon-16-command-line');
...
var _ElectricAPIAutocomplete = __webpack_require__(31);
 ...
 * @suppress {checkTypes}
 */
function __deltemplate_s80_d34389eb(opt_data, opt_ignored, opt_ijData) {
  ie_open('a', null, null,
...
exports.__deltemplate_s80_d34389eb = __deltemplate_s80_d34389eb;
if (goog.DEBUG) {
  __deltemplate_s80_d34389eb.soyTemplateName = 'Sidebar.__deltemplate_s80_d34389eb';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('ElectricNavigation.anchor.idom'), 'sidebar', 0, __deltemplate_s80_d34389eb);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "THcXb", function() { return THcXb; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(1);
...
/**
 * @fileoverview Templates in namespace THcXb.
 * @public
 */

goog.module('THcXb.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param562 = function() {
    ...
    ie_open('article', null, null,
        'id', '1');
      $templateAlias2({code: 'gh pull-request', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        itext('Alias:');
      ie_close('h4');
      $templateAlias2({code: 'gh pr', mode: 'javascript'}, null, opt_ijData);
      ie_open('h2');
        itext('Submit');
      ie_close('h2');
      ie_open('table');
      ...
      ie_close('table');
      ie_open('p');
        itext('Omitting a value for ');
        ie_open('code');
          itext('--submit');
        ie_close('code');
        itext(' fallbacks to the ');
        ie_open('code');
          itext('default_pr_reviewer');
        ie_close('code');
        itext(' key found in your ');
        ie_open('a', null, null,
            'href', '#config');
          itext('config file');
        ie_close('a');
        ...
        ie_open('code');
          itext('--title');
        ie_close('code');
        itext(' will submit a pull request using the last commit message as title.');
      ie_close('p');
      ie_open('h4');
        itext('Examples');
      ie_close('h4');
      ie_open('ul');
        ie_open('li');
          itext('Submit a pull request using the current branch.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr --submit eduardolundgren --title \'Fix #32\' --description \'Awesome fix\'', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Submit a pull request using the current branch to dev branch.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr --submit eduardolundgren --branch dev', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Submit a pull request from a issue.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr --submit eduardolundgren --issue 150', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '2');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Forward a pull request to another reviewer.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr 1 --fwd username', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '3');
      ie_open('h2');
        itext('Merge or rebase');
      ie_close('h2');
      ie_open('table');
        ie_open('thead');
          ie_open('tr');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('--number');
        ie_close('code');
        itext(' will try to guess the pull number from branch name e.g. ');
        ie_open('code');
          itext('pr-1');
        ie_close('code');
        itext(' results in ');
        ...
        ie_open('code');
          itext('--branch');
        ie_close('code');
        itext(' will merge or rebase into ');
        ie_open('code');
          itext('config.default_branch');
        ie_close('code');
        itext('.');
      ie_close('p');
      ie_open('h4');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Merge or rebase pull request into a branch.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr 1 --fetch --merge', mode: 'shell'}, null, opt_ijData);
      $templateAlias2({code: 'gh pr 1 --fetch --rebase', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Merge or rebase pull request into branch ');
          ie_open('code');
            itext('dev');
          ie_close('code');
          itext('.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr 1 --fetch --rebase --branch dev', mode: 'shell'}, null, opt_ijData);
      $templateAlias2({code: 'gh pr 1 --fetch --merge --branch dev', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '4');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          ie_open('strong');
            itext('Shortcut');
          ie_close('strong');
          itext(' for fetching pull request and checkout into a new branch ');
          ie_open('code');
            itext('pr-1');
          ie_close('code');
          itext('.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr 1', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Fech pull request rebasing or merging into the current branch.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr 1 --fetch --rebase', mode: 'shell'}, null, opt_ijData);
      $templateAlias2({code: 'gh pr 1 --fetch --merge', mode: 'shell'}, null, opt_ijData);
      ...
      ie_open('ul');
        ie_open('li');
          ie_open('strong');
            itext('Shortcut');
          ie_close('strong');
          itext(' for listing open pull requests for the current repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Get information about a pull request.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr --info number', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List open pull requests for all branches from all your repositories.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr --list --all', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List open pull requests for all branches in all repositories belonging to the "github" organization.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr --list --all --org github', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List open pull requests sent by logged user on current repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr --list --me', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List open pull requests with link and content.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr --list --detailed', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List open pull requests for a branch.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr --list --branch master', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List open pull requests and sort them by popularity ');
          ie_open('em');
            itext('(comment count)');
          ie_close('em');
          itext('.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr --list --sort popularity', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List open pull requests and sort them by asc long-running ');
          ie_open('em');
            itext('(old but still active)');
          ie_close('em');
          itext('.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr --list --sort long-running --direction asc', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List open pull requests and sort them by complexity ');
          ie_open('em');
            itext('(complexity is calculated based on number of additions, deletions, changed files, comments and review comments)');
          ie_close('em');
          itext('.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr --list --sort complexity', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '7');
      ie_open('h2');
    ...
    ie_open('article', null, null,
      ...
      ie_open('ul');
        ie_open('li');
          itext('Open a pull request.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr 1 --open', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Close a pull request.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr 1 --close', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Close multiple pull requests.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr --close --number 1 --number 2', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Open multiple pull requests.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr --open --number 1 --number 2', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Open or close a pull request that you\'ve sent to someone.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr 1 --close --user eduardolundgren', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '9');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Open GitHub pull request page in the browser.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh pr 100 --browser', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'THcXb.render';
}
...
class THcXb extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(THcXb, templates);
...
var THcXb = function (_Component) {
  _inherits(THcXb, _Component);

  function THcXb() {
    _classCallCheck(this, THcXb);

    return _possibleConstructorReturn(this, (THcXb.__proto__ || Object.getPrototypeOf(THcXb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(THcXb, _indexSoy2.default);

exports.default = THcXb;
