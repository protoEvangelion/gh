var pageComponent =
webpackJsonppageComponent([2,11,12],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LoOwM", function() { return LoOwM; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(1);
...
/**
 * @fileoverview Templates in namespace LoOwM.
 * @public
 */

goog.module('LoOwM.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param715 = function() {
    ...
    ie_open('article', null, null,
        'id', '1');
      $templateAlias2({code: 'gh repo', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        itext('Alias:');
      ie_close('h4');
      $templateAlias2({code: 'gh re', mode: 'javascript'}, null, opt_ijData);
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          ie_open('strong');
            itext('Shortcut');
          ie_close('strong');
          itext(' for opening the GitHub repository page in the browser.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Open GitHub repository page in the browser.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --browser --user eduardolundgren --repo node-gh', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '2');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('List all repositories.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --list', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List all private repositories.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --list --type private', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List all repositories from someone.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --list --user zenorocha', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '3');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Create a new GitHub repository and clone on the current directory.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --new foo --clone', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Create a new GitHub repository for an organization.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --new foo --organization node-gh', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Create a new GitHub repository using .gitignore template for Ruby.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --new gemified --gitignore Ruby', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Create a new private repository on GitHub, initializing it with a initial commit of the README.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --new foo --init --type private', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '4');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Fork a GitHub repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --fork repo --user user', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Fork a GitHub repository into the node-gh organization.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --fork repo --user user --organization node-gh', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '5');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Delete a repository of the logged user.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --delete foo', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '6');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Clone a repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --clone --repo gh', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Clone a repository from a specific user using HTTPS protocol.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --clone --user eduardolundgren --repo gh --protocol https', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '7');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Create a label for a repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --label --new bug --color color --repo gh', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Create a label for a user\'s repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --label --new bug --color color --user eduardolundgren --repo gh', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '8');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Delete a label from a repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --label --delete bug --repo gh', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Delete a label from a user\'s repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --label --delete bug --user eduardolundgren --repo gh', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '9');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('List labels for a repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --label --list --repo gh', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List labels for a user\'s repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --label --list --user eduardolundgren --repo gh', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '10');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Update a label for a repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --label --update bug --color color --repo gh', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Update a label for a user\'s repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh re --label --update bug --color color --user eduardolundgren --repo gh', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'LoOwM.render';
}
...
class LoOwM extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(LoOwM, templates);
...
var LoOwM = function (_Component) {
  _inherits(LoOwM, _Component);

  function LoOwM() {
    _classCallCheck(this, LoOwM);

    return _possibleConstructorReturn(this, (LoOwM.__proto__ || Object.getPrototypeOf(LoOwM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LoOwM, _indexSoy2.default);

exports.default = LoOwM;
