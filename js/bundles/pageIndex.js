var pageComponent =
webpackJsonppageComponent([0,11,12],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
function $render(opt_data, opt_ignored, opt_ijData) {
  ...
  $templateAlias1(soy.$$assignDefaults({content: param41}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
    ...
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('a', null, null,
          ...
          itext('Watch Our Demo');
        ie_close('a');
        ie_open('a', null, null,
            'href', '/docs/getting-started/',
            'class', 'btn btn-default');
          itext('Get Started Quick');
        ie_close('a');
      ie_close('div');
    ie_close('div');
  ie_close('header');
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('p', null, null,
            ...
            itext('Working with Github\'s UI can at times be painfully slow... especially when repetitive tasks could simply be executed from the CLI with much greater speed. That\'s why we created Node GH. To make tasks like opening, closing & forwarding Pull Requests a breeze!');
          ie_close('p');
        ie_close('div');
      ie_close('div');
    ie_close('div');
      ...
      ie_open('div', null, null,
        ...
        ie_open('section', null, null,
          ...
          ie_open('p', null, null,
            ...
            itext('A crowd favorite feature: interface with Github\'s Pull Request API right from your CLI');
          ie_close('p');
        ie_close('section');
        ie_open('section', null, null,
          ...
          ie_open('p', null, null,
              'class', 'feature-description');
            itext('Create & Modify Github Issues without having to navigate back & forth in your browser');
          ie_close('p');
        ie_close('section');
        ie_open('section', null, null,
            'class', 'feature col-md-4');
          ...
          ie_open('p', null, null,
              'class', 'feature-description');
            itext('Open, create & clone repos with simple commands like "gh re"');
          ie_close('p');
        ie_close('section');
      ie_close('div');
    ie_close('div');
    ...
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('p', null, null,
              'class', 'about-description');
            itext('One task that often takes up too much time is opening Pull Requests through the Github UI');
          ie_close('p');
          ie_open('div', null, null,
            ...
            ie_open('pre');
              ie_open('code', null, null,
                  ...
                  'data-mode', 'shell',
                  'ref', 'code');
                itext('gh pr --submit theUser --branch dev');
              ie_close('code');
            ie_close('pre');
            ie_open('div', null, null,
                'class', 'CodeMirror cm-s-dracula');
              ie_open('div', null, null,
                  'style', 'overflow: hidden; position: relative; width: 3px; height: 0px; top: 12px; left: 381.688px;');
              ...
              ie_open('div', null, null,
                ...
                ie_open('div', null, null,
                    ...
                    'style', 'margin-left: 60px; margin-bottom: -16px; border-right-width: 14px; min-height: 48px; min-width: 247.891px; padding-right: 0px; padding-bottom: 0px;');
                  ie_open('div', null, null,
                      ...
                      ie_open('div', null, null,
                        ...
                        ie_open('div', null, null,
                          ...
                          ie_open('div', null, null,
                              ...
                              'style', 'left: 321.688px; top: 0px; height: 24px;');
                            itext('\u00A0');
                          ie_close('div');
                        ie_close('div');
                        ie_open('div', null, null,
                          ...
                          ie_open('div', null, null,
                            ...
                            ie_open('div', null, null,
                              ...
                              ie_open('div', null, null,
                                  'class', 'CodeMirror-linenumber CodeMirror-gutter-elt',
                                  'style', 'left: 0px; width: 61px;');
                                itext('1');
                              ie_close('div');
                            ie_close('div');
                            ie_open('pre', null, null,
                ...
                ie_close('div');
                ie_void('div', null, null,
                    'style', 'position: absolute; height: 14px; width: 1px; border-bottom: 0px solid transparent; top: 48px;');
                ie_open('div', null, null,
          ...
          ie_open('p', null, null,
              'class', 'about-description');
            itext('Which can be simplified to:');
          ie_close('p');
          ie_open('div', null, null,
              'class', 'code-container');
            ie_open('button', null, null,
          ...
          ie_open('p', null, null,
              'class', 'about-description');
            itext('It\'s as simple as that! But if you need fine-tuned control when submitting your PR (like linking it to an issue #) there are plenty other flags available.');
          ie_close('p');
        ie_close('div');
      ie_close('div');
    ie_close('div');
...
function $highlights(opt_data, opt_ignored, opt_ijData) {
  ie_open('div', null, null,
    ...
    ie_open('div', null, null,
      ...
      ie_open('section', null, null,
        ...
        ie_open('div');
          ie_open('h4', null, null,
            ...
            itext('Save Time & Get Things Done Right From the CLI');
          ie_close('h4');
          ie_open('p', null, null,
              'class', 'highlight-description');
            itext('This screen cast shows how fast it is to add submit a PR. When your PR submits successfully, it will open it up in your browser. Bam!');
          ie_close('p');
        ie_close('div');
        ie_open('div');
      ...
      ie_close('section');
      ie_open('section', null, null,
          'class', 'highlight reverse');
        ie_open('div');
          ie_open('h4', null, null,
              'class', 'highlight-title');
            itext('Simplify Your CI');
          ie_close('h4');
          ie_open('p', null, null,
              'class', 'highlight-description');
            itext('If you want to execute commands programmatically & declaratively from your CI tasks, go for it!');
          ie_close('p');
        ie_close('div');
        ie_open('div');
      ...
      ie_open('section', null, null,
        ...
        ie_open('div');
          ie_open('h4', null, null,
              'class', 'highlight-title');
            itext('Enjoy Your Workflow');
          ie_close('h4');
          ie_open('p', null, null,
              'class', 'highlight-description');
            itext('Our lives are so often packed with endless activities. And sometimes it feels like we never have enough time. Our hope is that this tool will help you to stay focused, productive & happy while enjoying the comfort & speed of the good ol\' cli.');
          ie_close('p');
        ie_close('div');
        ie_open('div');
          ie_open('img', null, null,
              'class', 'dance-gif img-responsive',
