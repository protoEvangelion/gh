var pageComponent =
webpackJsonppageComponent([7,11,12],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "kYkVs", function() { return kYkVs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(1);
...
/**
 * @fileoverview Templates in namespace kYkVs.
 * @public
 */

goog.module('kYkVs.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param401 = function() {
    ...
    ie_open('article', null, null,
        'id', '1');
      $templateAlias2({code: 'gh issue', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        itext('Alias:');
      ie_close('h4');
      $templateAlias2({code: 'gh is', mode: 'javascript'}, null, opt_ijData);
      ie_open('h2');
        itext('Create');
      ie_close('h2');
      ie_open('table');
      ...
      ie_open('ul');
        ie_open('li');
          ie_open('strong');
            itext('Shortcut');
          ie_close('strong');
          itext(' for creating a new issue on the current repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is \'Node GH rocks!\' \'Body with **Markdown** support\'', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Create a new issue on a certain repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --new --title \'Node GH rocks!\' --message \'Body with **Markdown** support\' --user eduardolundgren --repo node-gh', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Create a new issue with labels.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --new --title \'Node GH rocks!\' --label bug,question,test', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Create a new issue and assign it to someone.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --new --title \'Node GH rocks!\' --assignee zenorocha', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '2');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Comment on an issue of the current repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is 1 --comment \'Node GH rocks!\'', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Comment on an issue of a certain repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is 1 --comment \'Node GH rocks!\' --user eduardolundgren --repo node-gh', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '3');
      ie_open('h2');
      ...
      ie_open('ul');
        ...
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is 1 --open', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Close an issue.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is 1 --close', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Close multiple issues.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --close --number 1 --number 2', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Open multiple issues.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --open --number 1 --number 2', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Open or close an issue that you\'ve sent to someone.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is 1 --close --user eduardolundgren', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '4');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          ie_open('strong');
            itext('Shortcut');
          ie_close('strong');
          itext(' for listing all issues on the current repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List all issues from all repositories.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --list --all', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List issues assigned to someone.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --list --assignee zenorocha', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List issues with link and content.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --list --detailed', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List only closed issues on the current repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --list --state closed', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List issues filtered by milestone.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --list --milestone 1', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List issues that contains labels ');
          ie_open('code');
            itext('todo');
          ie_close('code');
          itext(' and ');
        ...
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --list --label todo,bug', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('List all issues on a certain repository.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --list --user eduardolundgren --repo node-gh', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '5');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          ie_open('strong');
            itext('Shortcut');
          ie_close('strong');
          itext(' for opening GitHub issue page in the browser.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is 100', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Open GitHub issue page in the browser.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is 100 --browser', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '6');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Search issues in current repository');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --search \'term\'', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Search issues in all repositories for a user');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --all --user node-gh --search \'term\'', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Search issues in a repository for a user');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is  --user node-gh --repo gh --search \'term\'', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Search issues in a repository for a user with link and content');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is  --user node-gh --repo gh --search \'term\'', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Search issues with github filters');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is  --user node-gh --repo gh --search \'updated:<=2013-05-24\'', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '7');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Assign an issue on the current repository to a user.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --assign --assignee zenorocha --number 1', mode: 'shell'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('Assign an issue on a specific repository to a user.');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'gh is --assign --assignee zenorocha --number 1 --user eduardolundgren --repo gh', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'kYkVs.render';
}
...
class kYkVs extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(kYkVs, templates);
...
var kYkVs = function (_Component) {
  _inherits(kYkVs, _Component);

  function kYkVs() {
    _classCallCheck(this, kYkVs);

    return _possibleConstructorReturn(this, (kYkVs.__proto__ || Object.getPrototypeOf(kYkVs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kYkVs, _indexSoy2.default);

exports.default = kYkVs;
